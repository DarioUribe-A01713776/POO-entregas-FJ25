...
int DiaCalendario::getDia() const{
    return dia;
}
int DiaCalendario::getMes() const{
    return mes;
}
int DiaCalendario::getAnio() const{
    return anio;
}

void DiaCalendario::setDia(int d){
    dia = d;
}
void DiaCalendario::setMes(int m){
    mes = m;
}
void DiaCalendario::setAnio(int a){
    anio = a;
}
